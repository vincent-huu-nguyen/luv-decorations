import elegantExample from '../assets/elegantExample.jpg';
...
const Services = () => {
    ...
    return (
        <section id="services" className="py-20 px-6 bg-cover text-center"
            style={{ backgroundImage: `url(${elegantExample})` }}>

...
const Contact = () => {
    return (
        <section id="contact" className="py-20 px-6 bg-cover text-center"
            ...
            <h2 className="text-4xl font-semibold text-gold font-[cursive]">Let’s Make Your</h2>
            <h2 className="text-4xl font-semibold text-gold font-[cursive] mb-4">Vision a Reality</h2>

            <p className="text-gray-700 mb-7">We’re just one call away from transforming your next event.</p>
            <a
